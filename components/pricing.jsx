  ...
  return (
    <div
      ...
      className={`relative backdrop-blur-lg border rounded-3xl p-8 transition-all duration-700 cursor-pointer ${
        featured
          ? "bg-gradient-to-b from-blue-500/20 to-purple-600/20 border-blue-400/50 scale-103"
          : "bg-white/5 border-white/10"
      } ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"} ${
        isHovered ? "transform scale-106 z-10" : ""
      }`}
...
const PricingSection = () => {
  const plans = [
    ...
    },
    {
      ...
      featured: true,
      planId: "cplan_368qAdmOhyHkwHQpXx56fJGxCRm",
